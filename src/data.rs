...
static RKHUNTER_CHECKS_SHORT: &str = include_str!("../data/rkhunter_checks_short.txt");
static RKHUNTER_INFOS: &str = include_str!("../data/rkhunter_infos.txt");
...
lazy_static::lazy_static! {
    ...
    pub static ref RKHUNTER_CHECKS_SHORT_LIST: Vec<&'static str> = RKHUNTER_CHECKS_SHORT.lines().collect();
    pub static ref RKHUNTER_INFOS_LIST: Vec<&'static str> = RKHUNTER_INFOS.lines().collect();

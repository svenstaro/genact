...
impl Module for LlmTraining {
    ...
    async fn run(&self, appconfig: &AppConfig) {
        ...
        print(format!("[INFO] Using mixed precision training ({precision}).")).await;
        newline().await;
        ...
        for &file_size in &file_sizes {
            ...
            for step in 0..=bar_steps {
                ...
                let size_opts =
                    FormatSizeOptions::from(humansize::BINARY).space_after_value(false);
        ...
        for epoch in 1..=num_epochs {
            ...
            for i in 0..=epoch_bar_steps {
                ...
                if i == 0 {
                    ...
                    let remaining_secs =
                        simulated_epoch_secs * (epoch_bar_steps - i) as u64 / epoch_bar_steps as u64;
